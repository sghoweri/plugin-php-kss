...
/*!
 * Pattern Lab KSS Plugin Parser Class
 *
 * Copyright (c) 2014 Dave Olsen, http://dmolsen.com
 * Licensed under the MIT license
 *
 * Basically a direct copy of the code from scan/kssphp with slight modifications to add patterns as the reference
 * Original is Copyright (c) 2013 Scan, Inc. and released under the MIT license.
 *
 * -----------------------
 *
 * Parser
...
use \PatternLab\KSSPlugin\Section;
...
class Parser {
	...
	protected function sortSections() {
		...
		uasort($this->sections, '\KSSPlugin\Section::depthScoreSort');
	...
	protected function sortSectionsByDepth() {
		uasort($this->sections, '\KSSPlugin\Section::depthSort');
		$this->sectionsSortedByReference = false;
	}
